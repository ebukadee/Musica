...
const Hero = () => {
  return (
    ...
    <div className=" overflow-hidden flex h-auto  relative bg-[#609EAF] w-[100%]   rounded-[40px] top-0 px-6 py-4  lg:w-[800px] ">
      ...
      <span>
        <img
          className=" hidden absolute w-[230px] h-[380px] left-[470px] bottom-[0px] z-10 lg:block"
          src={model}></img>
        <img
          src={string}
          className=" h-[230px] absolute left-[150px]  right-[0] bottom-[400px] rotate-90  lg:h-[530px]  lg:rotate-0 lg:bottom-[0px] lg:top-[0px]"></img>
      </span>
    </div>
  );
};
